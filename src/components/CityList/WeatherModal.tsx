...
//           <WeatherIcon code={weatherData[selectedCity]?.weather?.[0]?.id} big />
//           <span className="font-light text-7xl text-blue-500 ml-4">
//             <Temperature
//               value={kelvinToCelcius(
//                 weatherData[selectedCity]?.main?.temp || 0
//               )}
//             />
...
//           {weatherData[selectedCity]?.weather?.[0]?.description ||
...
//             <Temperature
//               value={kelvinToCelcius(
//                 weatherData[selectedCity]?.main?.feels_like || 0
//               )}
//             />
//             <sup>&deg;</sup>
//           </p>
...
//               <Temperature
//                 value={kelvinToCelcius(
//                   weatherData[selectedCity]?.main?.temp_max || 0
//                 )}
//               />
//               <sup>&deg;</sup>
//             </div>
...
//               <Temperature
//                 value={kelvinToCelcius(
//                   weatherData[selectedCity]?.main?.temp_min || 0
//                 )}
//               />
//               <sup>&deg;</sup>
//             </div>
...
//                 {weatherData[selectedCity]?.main?.humidity || 0}%
//               </span>
//             </div>
...
//                 <span className="text-blue-500 text-lg font-medium">Wind:</span>
//               </div>
//               <p className="text-blue-500 font-medium text-lg">
//                 {weatherData[selectedCity]?.wind?.speed
//                   ? `${Math.round(
//                       weatherData[selectedCity]?.wind?.speed * 3.6
//                     )} kph`
//                   : "N/A"}
//               </p>
//             </div>
...
//                 {weatherData[selectedCity]?.main?.pressure || 0} hPa
//               </span>
//             </div>
//           </div>
